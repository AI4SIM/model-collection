...
class TestPlotters(unittest.TestCase):
    ...
    def test_dispersion_plot(self):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            self.assertTrue(
                os.path.exists(
                    os.path.join(tempdir, f"dispersion-plot-{self.model_type}.png")
                )
            )
    ...
    def test_histo(self):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            self.assertTrue(
                os.path.exists(
                    os.path.join(tempdir, f"histogram-{self.model_type}.png")
                )
            )
    ...
    def test_histo2d(self):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            self.assertTrue(
                os.path.exists(
                    os.path.join(tempdir, f"histogram2d-{self.model_type}.png")
                )
            )
    ...
    def test_total_flame_surface(self):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            self.assertTrue(
                os.path.exists(
                    os.path.join(
                        tempdir, f"total-flame-surface-{self.model_type}-0.png"
                    )
                )
            )
            self.assertTrue(
                os.path.exists(
                    os.path.join(
                        tempdir, f"total-flame-surface-{self.model_type}-1.png"
                    )
                )
            )
            self.assertTrue(
                os.path.exists(
                    os.path.join(
                        tempdir, f"total-flame-surface-{self.model_type}-2.png"
                    )
                )
            )
    ...
    def test_cross_section(self):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            self.assertTrue(
                os.path.exists(
                    os.path.join(tempdir, f"cross-section-{self.model_type}-0.png")
                )
            )
            self.assertTrue(
                os.path.exists(
                    os.path.join(tempdir, f"cross-section-{self.model_type}-1.png")
                )
            )
            self.assertTrue(
                os.path.exists(
                    os.path.join(tempdir, f"cross-section-{self.model_type}-2.png")
                )
            )
