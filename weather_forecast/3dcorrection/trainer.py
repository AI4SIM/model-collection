...
class Trainer(pl.Trainer):
    """
    Modified PyTorch Lightning Trainer that automatically tests, logs, and writes artifacts by the end of training.
    """
    ...
    def __init__(self, 
        ...
        """
        Args:
            accelerator (Union[str, pl.accelerators.Accelerator, None]): Type of accelerator to use for training.
    ...
    def test(self, **kwargs) -> None:
        """
        Uses superclass test results, but additionally, saves raw results as a JSON file, and stores the model weights for future use in inference mode.
