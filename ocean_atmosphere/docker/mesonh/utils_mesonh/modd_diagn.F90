...
!!      J. Pianezze 04/2022 : add diagnostics vars.
!
!*       0.   DECLARATIONS
!             ------------
!
...
!
  ...
  LOGICAL :: LDIAG_OAFLUX ! flag to activate OA flux outputs
!  
...
!++ JORIS DGF MODIF ++
  REAL, POINTER, DIMENSION(:)   :: XDIAG_USTAR   
  REAL, POINTER, DIMENSION(:)   :: XDIAG_TSTAR
  REAL, POINTER, DIMENSION(:)   :: XDIAG_QSTAR
  REAL, POINTER, DIMENSION(:)   :: XDIAG_ZDU
  REAL, POINTER, DIMENSION(:)   :: XDIAG_ZDWG
  REAL, POINTER, DIMENSION(:)   :: XDIAG_PTA
  REAL, POINTER, DIMENSION(:)   :: XDIAG_PEXNA
  REAL, POINTER, DIMENSION(:)   :: XDIAG_SSTS
  REAL, POINTER, DIMENSION(:)   :: XDIAG_PEXNS
  REAL, POINTER, DIMENSION(:)   :: XDIAG_PQSAT
  REAL, POINTER, DIMENSION(:)   :: XDIAG_PQA
  REAL, POINTER, DIMENSION(:)   :: XDIAG_PUREF
  REAL, POINTER, DIMENSION(:)   :: XDIAG_PZREF
  REAL, POINTER, DIMENSION(:)   :: XDIAG_ZPUZ
  REAL, POINTER, DIMENSION(:)   :: XDIAG_ZPTZ
  REAL, POINTER, DIMENSION(:)   :: XDIAG_ZPQZ
  REAL, POINTER, DIMENSION(:)   :: XDIAG_PRHOA
  REAL, POINTER, DIMENSION(:)   :: XDIAG_ZLV
  REAL, POINTER, DIMENSION(:)   :: XDIAG_CDN
  REAL, POINTER, DIMENSION(:)   :: XDIAG_CHN
  REAL, POINTER, DIMENSION(:)   :: XDIAG_CEN
!-- JORIS DGF MODIF --
...
! ++ JORIS DGF ++
  NULLIFY(D%XDIAG_USTAR)
  NULLIFY(D%XDIAG_TSTAR)
  NULLIFY(D%XDIAG_QSTAR)
  NULLIFY(D%XDIAG_ZDU)
  NULLIFY(D%XDIAG_ZDWG)
  NULLIFY(D%XDIAG_PTA)
  NULLIFY(D%XDIAG_PEXNA)
  NULLIFY(D%XDIAG_SSTS)
  NULLIFY(D%XDIAG_PEXNS)
  NULLIFY(D%XDIAG_PQSAT)
  NULLIFY(D%XDIAG_PQA)
  NULLIFY(D%XDIAG_PUREF)
  NULLIFY(D%XDIAG_PZREF)
  NULLIFY(D%XDIAG_ZPUZ)
  NULLIFY(D%XDIAG_ZPTZ)
  NULLIFY(D%XDIAG_PRHOA)
  NULLIFY(D%XDIAG_ZLV)
  NULLIFY(D%XDIAG_CDN)
  NULLIFY(D%XDIAG_CHN)
  NULLIFY(D%XDIAG_CEN)
