...
!     #########
    SUBROUTINE ECUME_SEAFLUX(S,DGO,D,PMASK,KSIZE_WATER,KSIZE_ICE,   &
...
IF (YTYPE=='W') THEN
  ...
  IF(S%CSEA_FLUX=='ECUME6')THEN
    !new ecume scheme
    CALL ECUMEV6_FLUX(DGO,D,ZW_Z0SEA,ZW_TA,ZW_EXNA,ZW_RHOA,ZW_SST,ZW_SSS,ZW_EXNS,  &
  ...
  ELSE
    !old ecume scheme
    CALL ECUME_FLUX(DGO,D,ZW_Z0SEA,ZW_TA,ZW_EXNA,ZW_RHOA,ZW_SST,ZW_EXNS,        &
